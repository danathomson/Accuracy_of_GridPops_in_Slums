...
#library(NCmisc)
#list.functions.in.file("C:/Users/dthomson.CIESIN_NT/Dropbox/Work_main/p_ciesin_pop_slum_compare/code/paper3/part3_SDG11_v3.R", alphabetic = TRUE)
#print(sessionInfo())
...
write.csv(sdg, "C:/Users/dthomson.CIESIN_NT/Dropbox/Work_main/p_ciesin_pop_slum_compare/output/sdg.csv", row.names = TRUE)
...
ggsave("C:/Users/dthomson.CIESIN_NT/Dropbox/Work_main/p_ciesin_pop_slum_compare/paper_3/fig_8_sdg_v2.tiff", fig_sdg, units="in", width=6, height=2.5, dpi=400, compression = 'lzw')
ggsave("C:/Users/dthomson.CIESIN_NT/Dropbox/Work_main/p_ciesin_pop_slum_compare/paper_3/fig_8_sdg_v2.png", fig_sdg, units="in", width=6, height=2.5, dpi=400)
