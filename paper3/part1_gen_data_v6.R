...
### v5 Inclusion criteria for gridded pops                 ###
...
### v6 1 year for HRSL, GRID3 NGA, LandScan-G. Change GRID3 NGAv2.0 --> NGAv2.1. Replace RGDAL commands
...
slums <- st_read("kyc_campaign/nga/kyc_cln_data_Lagos_Nigeria.shp") 
slums <- slums[, c("Country", "City", "Settlement", "Last_updat", "kyc_pop")]
names(slums)[4:5] <- c("KYC_Year", "KYC_Pop")
...
# Project slums in UTM
slums <- st_transform(slums, crs = proj.utm31)
...
#GRID3 Nigeria v2.1 (2019)
grid19 <- raster("grid3/NGA_population_v2_1_gridded/NGA_population_v2_1_gridded.tif")
...
# KnowYourCity Campaign slum boundaries
slums <- st_read("kyc_campaign/nga/kyc_cln_data_PortHarcourt_Nigeria.shp") 
...
# Project slums in UTM
slums <- st_transform(slums, crs = proj.utm32)
...
# KnowYourCity Campaign slum boundaries
slums <- st_read("kyc_campaign/ken/kyc_cln_data_Nairobi_Kenya.shp") 
...
# Project slums in UTM
slums <- st_transform(slums, crs = proj.utm37)
...
# KnowYourCity Campaign slum boundaries
slums <- st_read("kyc_campaign/ken/kyc_cln_data_Kisumu_Kenya.shp")
...
# KnowYourCity Campaign slum boundaries
slums <- st_read("kyc_campaign/tza/kyc_cln_data2_DarEsSalaam_Tanzania.shp")
slums <- slums[,names(slums) %in% c("Country", "City", "Settlement", "Last_Updat", "pop")]
names(slums)[4:5] <- c("KYC_Year", "KYC_Pop")
...
# KnowYourCity Campaign slum boundaries
slums <- st_read("kyc_campaign/uga/kyc_cln_data_Kampala_Uganda.shp")
slums <- slums[,names(slums) %in% c("Country", "City", "Settlement", "Last_Updat", "pop")]
names(slums)[4:5] <- c("KYC_Year", "KYC_Pop")
...
# Project slums in UTM
slums <- st_transform(slums, crs = proj.utm36)
...
# KnowYourCity Campaign slum boundaries
slums <- st_read("kyc_campaign/zaf/kyc_cln_data_CapeTown_SouthAfrica.shp")
slums <- slums[,names(slums) %in% c("Country", "City", "Settlement", "Last_Updat", "pop")]
names(slums)[4:5] <- c("KYC_Year", "KYC_Pop")
...
# Project slums in UTM
slums <- st_transform(slums, crs = proj.utm33)
...
# KnowYourCity Campaign slum boundaries
slums <- st_read("kyc_campaign/gha/kyc_cln_data_Accra_Ghana.shp")
slums <- slums[,names(slums) %in% c("Country", "City", "Settlement", "Last_Updat", "pop")]
names(slums)[4:5] <- c("KYC_Year", "KYC_Pop")
...
# Project slums in UTM
slums <- st_transform(slums, crs = proj.utm30)
...
# KnowYourCity Campaign slum boundaries
slums <- st_read("kyc_campaign/phl/kyc_cln_data_Davao_Philippines.shp")
slums <- slums[,names(slums) %in% c("Country", "City", "Settlement", "Last_Updat", "pop")]
names(slums)[4:5] <- c("KYC_Year", "KYC_Pop")
...
# Project slums in UTM
slums <- st_transform(slums, crs = proj.utm51)
...
# KnowYourCity Campaign slum boundaries
slums <- st_read("kyc_campaign/phl/kyc_cln_data_Malabon_Philippines.shp")
slums <- slums[,names(slums) %in% c("Country", "City", "Settlement", "Last_Updat", "pop")]
names(slums)[4:5] <- c("KYC_Year", "KYC_Pop")
...
slums$lsg_combo <- slums$lsg20
slums$lshd_combo <- slums$lshd20
slums$grid_combo <- slums$grid19
...
write.csv(slums, file="kyc_campaign/COMBINED/slums_v11.csv")  # includes estimates for all settlements