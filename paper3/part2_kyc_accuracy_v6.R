...
### v6 Inclusion criteria for gridded pops                 ###
###    a. One version - use for all settlements: WorldPop-C 2020, WorldPop-PB 2020, LandScan-HD 2020
###    b. Multiple versions that supplant each other - use for all settlements: HRSLv1.5 (2018-2020), GRID3-NGAv2.1 (2019), LandScan-G 2020
###    c. One version for multiple years - match to settlement year: GHS-POP2, WorldPop-U, GPWv4.11
...
#library(NCmisc)
#list.functions.in.file("C:/Users/dthomson.CIESIN_NT/Dropbox/Work_main/p_ciesin_pop_slum_compare/code/paper3/part2_kyc_accuracy_v4.R", alphabetic = TRUE)
#print(sessionInfo())


#Read analysis dataset & merge city characteristics

cities <- read_excel("C:/Users/dthomson.CIESIN_NT/Dropbox/Work_main/p_ciesin_pop_slum_compare/paper_3/cities_data_v3.xlsx", sheet = "cities - analysis 1")
...
slums <- read.csv("C:/Users/dthomson.CIESIN_NT/Dropbox/Work_main/p_ciesin_pop_slum_compare/data/kyc_campaign/COMBINED/slums_v11.csv")
...
datasets <- as.data.frame(rbind("GPWv4.11", "WorldPop-U", "LandScan-G", "LandScan-HD", "GHS-POP2", "GRID3-NGAv2.1", "WorldPop-PB", "WorldPop-C", "HRSLv1.5"))
...
write.csv(errorstats_wide, file="C:/Users/dthomson.CIESIN_NT/Dropbox/Work_main/p_ciesin_pop_slum_compare/paper_3/t1_error_stats_v4.csv")   # for data quality check of reported vs digitised area
...
dev.off()
ggsave("C:/Users/dthomson.CIESIN_NT/Dropbox/Work_main/p_ciesin_pop_slum_compare/paper_3/fig_2_boxplot_v6.png", fig_distribution, units="in", width=8, height=3.5, dpi=400)
ggsave("C:/Users/dthomson.CIESIN_NT/Dropbox/Work_main/p_ciesin_pop_slum_compare/paper_3/fig_2_boxplot_v6.tiff", fig_distribution, units="in", width=8, height=3.5, dpi=400, compression = 'lzw')
...
dev.off()
ggsave("C:/Users/dthomson.CIESIN_NT/Dropbox/Work_main/p_ciesin_pop_slum_compare/paper_3/fig_4_overall_error_v6.tiff", fig_overall_error, units="in", width=8, height=3.5, dpi=300, compression = 'lzw')
ggsave("C:/Users/dthomson.CIESIN_NT/Dropbox/Work_main/p_ciesin_pop_slum_compare/paper_3/fig_4_overall_error_v6.png", fig_overall_error, units="in", width=8, height=3.5, dpi=300)
...
379 - 476     #Diff MAE   = -97
523 - 644   #Diff RMSE  = -121
0.421 - 0.318 #Diff MF    = 0.103


#from errorstats_wide_pooled: WPG-U minus GPW
462 - 470     #Diff MAE   = -8
...
mf_wide_pooled$dataset[mf_wide_pooled$dataset=="frac_hrsl"] <- "HRSLv1.5"
...
mf_wide_pooled$dataset[mf_wide_pooled$dataset=="frac_grid"] <- "GRID3-NGAv2.1"
...
dev.off()
ggsave("C:/Users/dthomson.CIESIN_NT/Dropbox/Work_main/p_ciesin_pop_slum_compare/paper_3/fig_5_citymfplot_v4.tiff", fig_mfplot_pool, units="in", width=8, height=3.5, dpi=300, compression = 'lzw')
ggsave("C:/Users/dthomson.CIESIN_NT/Dropbox/Work_main/p_ciesin_pop_slum_compare/paper_3/fig_5_citymfplot_v4.png", fig_mfplot_pool, units="in", width=8, height=3.5, dpi=300)
...
city_pred <- read_excel("C:/Users/dthomson.CIESIN_NT/Dropbox/Work_main/p_ciesin_pop_slum_compare/paper_3/cities_data_v3.xlsx", sheet = "cities - accuracy")
data_pred <- read_excel("C:/Users/dthomson.CIESIN_NT/Dropbox/Work_main/p_ciesin_pop_slum_compare/paper_3/cities_data_v3.xlsx", sheet = "data - accuracy")
...
png("C:/Users/dthomson.CIESIN_NT/Dropbox/Work_main/p_ciesin_pop_slum_compare/paper_3/fig_6_cause_corr3.png", units="in", width=8.5, height=8.8, res=300, pointsize = 16)
